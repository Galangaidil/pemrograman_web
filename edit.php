...
// Menyimpan data kota ke variabel
...
function edit($data)
{
  ...
  $query = "UPDATE kota SET IDKota = '$IDKota', NamaKota = '$NamaKota', NamaPemimpin = '$NamaPemimpin', TglBerdiri = '$TglBerdiri', JmlPenduduk = '$JmlPenduduk', LuasWilayah = '$LuasWilayah', JenisKota = '$JenisKota', Keunggulan = '$Keunggulan' WHERE IDKota = '$IDKota'";
...
<head>
  ...
  <title>Edit kota : <?= $NamaKota ?></title>
</head>

<body>
  <div class="container">
    <h1 class="display-4">Mode edit kota : <?= $NamaKota ?></h1>
    ...
    <form action="" method="post">
      <div class="row g-3">
        ...
        <div class="d-grid gap-2">
          <button type="submit" name="submit" onclick="return confirm('Anda yakin ingin mengubah data ini?')" class="btn btn-primary">Edit</button>
        </div>
